  ...
  return (
    ...
    <div id="projectThree" className="h-max p-5 lg:flex lg:justify-center">
      <div id="project-content" className="  w-fit mx-auto">
        ...
        <p className=" max-w-lg break-normal xl:text-xl ">World of Drinks ia a web application that provides users with information
          ...
          I created this application using The Cocktail Databse API and deployed it using Heroku.
        </p>
        </div>
